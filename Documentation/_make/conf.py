# -*- coding: utf-8 -*-
#
# Brute Force Protection documentation build configuration file, created by
# TYPO3 extension sphinx on Tue, 27 Jan 2015 10:40:45 +0100.
#
...
project = u'Brute Force Protection'
copyright = u'2015, Kevin Schu, Andre Wuttig'
...
htmlhelp_basename = 'felogin_bruteforce_protectiondoc'
...
latex_documents = [
    ('Index', 'felogin_bruteforce_protection.tex', u'Brute Force Protection',
     u'Kevin Schu, Andre Wuttig', 'manual'),
]
...
pdf_documents = [
    ('Index', 'felogin_bruteforce_protection', u'Brute Force Protection',
     u'Kevin Schu, Andre Wuttig'),
]
...
texinfo_documents = [
    ('Index', 'felogin_bruteforce_protection', u'Brute Force Protection',
     u'Kevin Schu, Andre Wuttig', 'Brute Force Protection', 'One line description of project.',
     'Miscellaneous'),
]
